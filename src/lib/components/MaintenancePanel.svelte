      ...
      {#if maintenance}
        <div class="diagTable">
          <div class="diagCard">
            ...
            <div class="diagLine">
              <span class="diagKey">Bytes</span>
              <span class="diagValue">{maintenance.generatedIconsBytes}</span>
            </div>
          </div>
          ...
          <div class="diagCard">
            ...
            <div class="diagLine">
              <span class="diagKey">Bytes</span>
              <span class="diagValue">{maintenance.manualIconsBytes}</span>
            </div>
          </div>
          ...
          <div class="diagCard">
            ...
            <div class="diagLine">
              <span class="diagKey">Bytes</span>
              <span class="diagValue">{maintenance.backupsBytes}</span>
            </div>
          </div>
          ...
          <div class="diagCard">
            ...
            <div class="diagLine">
              <span class="diagKey">Bytes</span>
              <span class="diagValue">{maintenance.orphanGeneratedIconsBytes}</span>
            </div>
          </div>

          <div class="diagCard">
            <div class="diagTopRow">
              <strong>Total tracked bytes</strong>
              <span>{maintenance.totalBytes}</span>
            </div>
            <div class="diagLine">
        ...
        {#if lastCleanupResult}
          <div class="diagCard" style="margin-top: 10px;">
            ...
            <div class="diagLine">
              <span class="diagKey">Removed bytes</span>
              <span class="diagValue">{lastCleanupResult.removedBytes}</span>
            </div>
